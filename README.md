...
1. **[AGENT_INSTRUCTIONS.md](./AGENT_INSTRUCTIONS.md)** - Instructions for AI agents working on this project
2. **[DESIGN_SYSTEM.md](./DESIGN_SYSTEM.md)** - Complete design system documentation
3. **[DEPLOYMENT.md](./DEPLOYMENT.md)** - Deployment guide for emergent.sh
4. **[TROUBLESHOOTING.md](./TROUBLESHOOTING.md)** - Figma Make → emergent.sh fixes
5. **[DESIGN_QUICK_REFERENCE.md](./DESIGN_QUICK_REFERENCE.md)** - One-page cheat sheet
